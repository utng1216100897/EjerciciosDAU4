...
import utng.hoteljsf.repository.UsuarioRepository;
@ManagedBean
public class UsuarioBean {
	...
	private Long rolSeguridadID = 0L;
	
	public void save() {
		RolSeguridadRepository rolSeguridadRepository = new RolSeguridadRepository(
				this.entityManager);
